...
export const TeamChat: React.FC<TeamChatProps> = ({
  ...
  const formatMessageWithLinksAndEmojis = (content: string, isOwnMessage: boolean): JSX.Element => {
    console.log('🔍 Debug - formatMessageWithLinksAndEmojis input:', content);
    ...
    console.log('🔍 Debug - Testing asset regex on:', contentWithEmojis);
    const assetMatches = contentWithEmojis.match(assetRegex);
