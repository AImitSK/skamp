  ...
  return (
    <div className="space-y-6">
      ...
      {timelineData.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <Subheading className="mb-4">📈 Veröffentlichungen über Zeit</Subheading>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {outletDistribution.length > 0 && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <Subheading className="mb-4">📰 Medium-Verteilung</Subheading>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
        ...
        {sentimentData.length > 0 && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <Subheading className="mb-4">💭 Sentiment-Verteilung</Subheading>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={sentimentData}
      ...
      {topOutlets.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <Subheading className="mb-4">🏆 Top 5 Medien nach Reichweite</Subheading>
          <ResponsiveContainer width="100%" height={300}>
