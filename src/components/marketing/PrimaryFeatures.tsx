...
export function PrimaryFeatures() {
  ...
  return (
    ...
    >
      <Image
        className="absolute top-1/2 left-1/2 max-w-none tranzinc-x-[-44%] tranzinc-y-[-42%]"
        src={backgroundImage}
        alt=""
        width={2245}
        height={1636}
              ...
              <TabPanels className="lg:col-span-7">
                {features.map((feature) => (
                  <TabPanel key={feature.title} unmount={false}>
                    ...
                    <div className="mt-10 w-180 overflow-hidden rounded-xl bg-zinc-50 shadow-xl shadow-blue-900/20 sm:w-auto lg:mt-0 lg:w-271.25">
                      <Image
                        className="w-full"
                        src={feature.image}
                        alt=""
