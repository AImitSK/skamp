  ...
  return (
    <section
      className={clsx(
        ...
        featured ? 'order-first bg-primary py-8 lg:order-0' : 'lg:py-8',
      )}
    >
      ...
      <Container>
        <div className="md:text-center">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl">
            <span className="relative whitespace-nowrap">
              ...
              <span className="relative">Transparente Preise,</span>
            </span>{' '}
            für jede Größe.
          </h2>
          <p className="mt-4 text-lg text-zinc-400">
            Von Solo-Selbständigen bis zu großen Agenturen – wähle den Plan, der zu dir passt.
            14 Tage Geld-zurück-Garantie bei allen Paketen.
          </p>
        </div>
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-10 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          <Plan
            name="Starter"
            price="€49"
            description="Perfekt für Solo-Selbständige und kleine PR-Teams."
            href="/signup?plan=STARTER"
            features={[
              '2.500 E-Mails pro Monat',
              '1.000 Kontakte',
              '50.000 KI-Wörter pro Monat',
              '1 Benutzer',
              '5 GB Cloud-Speicher',
              'E-Mail Support',
            ]}
          ...
          <Plan
            ...
            name="Business"
            price="€149"
            description="Ideal für wachsende Unternehmen und PR-Abteilungen."
          ...
          <Plan
            name="Agentur"
            price="€399"
            description="Für Agenturen mit höchsten Ansprüchen."
