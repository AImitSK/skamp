...
async function Posts({ page, category }: { page: number; category?: string }) {
  ...
  if (posts.length === 0) {
    return <p className="mt-6 text-gray-500">Keine Artikel gefunden.</p>
  }
    ...
    <main className="overflow-hidden">
      ...
      <Container>
        ...
        <Heading as="h1" className="mt-2">
          Was bei CeleroPress passiert.
        </Heading>
        <Lead className="mt-6 max-w-3xl">
          Bleib informiert mit Product-Updates, News und Einblicken, wie du deine
          PR-Arbeit optimierst.
        </Lead>
      </Container>
