...
export function TagInput({ value, onChange, placeholder }: TagInputProps) {
  ...
  return (
    <div className="min-h-[42px] w-full rounded-md border border-zinc-300 bg-white px-3 py-2 focus-within:border-primary focus-within:ring-1 focus-within:ring-primary">
